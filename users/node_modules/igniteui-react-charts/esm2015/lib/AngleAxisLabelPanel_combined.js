        ...
        az() {
            ...
            if (c) {
                for (let d = 0; d < a.count; d++) {
                    ...
                    let f = this.a3._inner[d];
                    let g = a._inner[d];
                    let h = this.c0(f.c);
                    let i = h.x - this.bd(e) / 2;
                    let j = h.y - this.bc(e) / 2;
                    g.x = i;
                    g.y = j;
                    a._inner[d] = g;
                }
    ...
    class CategoryAngleAxis extends CategoryAxisBase {
        ...
        au() {
            ...
            a.c0 = (b) => {
                ...
                return this.l3(b, { $type: Point_$type, x: 0.5, y: 0.5 }, c, d, this.av.ba);
            };
            return a;
        }
        lo(a) {
        ...
        k5() {
            ...
            b.b.c = (c) => {
                if ((this.ay == null || this.ay.visibility == 0) && this.k8 != null && this.le != c) {
    ...
    class NumericAngleAxis extends NumericAxisBase {
        ...
        au() {
            ...
            a.c0 = (b) => {
                let c = this.bh != null ? this.bh.mr : Rect.empty;
                let d = !c.isEmpty ? this.i8 : Rect.empty;
                return this.lz(b, { $type: Point_$type, x: 0.5, y: 0.5 }, c, d, this.av.ba);
            };
            return a;
        }
        lq() {
        ...
        jk() {
            let a = super.jk();
            a.b.c = (b) => {
                if ((this.ay == null || this.ay.visibility == 0) && this.ll != null && this.lo != b) {
...
export let NumericRadiusAxis = /*@__PURE__*/ (() => {
    class NumericRadiusAxis extends NumericAxisBase {
        ...
        jk() {
            let a = super.jk();
            a.b.c = (b) => {
                if ((this.ay == null || this.ay.visibility == 0) && this.lk != null) {
                    if ((this.ay == null || (this.ay.c == 4 || this.ay.c == 5)) && this.lo != b) {
                        this.lo = b;
                        this.av.a9 = b;
                        this.bh.hu();
                    }
...
export let AngleAxisLabelPanelView = /*@__PURE__*/ (() => {
    class AngleAxisLabelPanelView extends AxisLabelPanelBaseView {
        ...
        ay(a, b) {
            ...
            for (let c = 0; c < this.a.a4.count; c++) {
                let d = this.a.a4._inner[c];
                let e = this.a.a3._inner[c];
                let f = e.a;
                let g = this.ax.c0(e.c);
                let h = this.m(d);
                let i = this.l(d);
