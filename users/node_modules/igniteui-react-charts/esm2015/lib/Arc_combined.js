...
export let Arc = /*@__PURE__*/ (() => {
    class Arc extends PieChartBase {
        ...
        f0() {
            ...
            for (let b of fromEnum(this.bo.a)) {
                ...
                if (this.an != null && !g.isOthersSlice) {
                    let i = this.an.i(g);
                    g.legendLabel = i;
                }
                if (this.ao != null && g.isOthersSlice) {
                    let j = this.ao.i(g);
                    g.legendLabel = j;
                }
    ...
    Arc.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, Arc, 'fw', ['EndAngle:ia:id', [1, 360]]);
    return Arc;
})();
/**
 * @hidden
...
export let RingSeriesBase = /*@__PURE__*/ (() => {
    ...
    RingSeriesBase.dl = /*@__PURE__*/ DependencyProperty.i("LabelTemplate", DataTemplate.$, RingSeriesBase.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => (typeCast(RingSeriesBase.$, a)).c3("LabelTemplate", b.oldValue, b.newValue)));
    RingSeriesBase.dc = /*@__PURE__*/ DependencyProperty.i("IsSurfaceInteractionDisabled", Boolean_$type, RingSeriesBase.$, /*@__PURE__*/ new PropertyMetadata(2, false, (a, b) => a.c3("IsSurfaceInteractionDisabled", b.oldValue, b.newValue)));
    RingSeriesBase.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, RingSeriesBase, 'c3', ['Brushes:ak:c8', [BrushCollection.$, null], 'FastItemsSource:ay:c9', [FastItemsSource.$], 'FormatLabel:aq:da', [Delegate_$type], 'FormatLegendLabel:ar:db', [Delegate_$type], 'ItemsSource::dd', [IEnumerable_$type, null], 'LabelExtent:a4:de', [1, 10], 'LabelFormat:bj:df', [2, null], 'LabelFormatSpecifiers:ag:dg', [Array_$type, null], 'LabelInnerColor:ec:dh', [Brush.$, null], 'LabelMemberPath:bn:di', [2], 'LabelOuterColor:ed:dj', [Brush.$, null], 'LabelsPosition:an:dk', [LabelsPosition_$type, /*@__PURE__*/ enumGetBox(LabelsPosition_$type, 1)], 'LeaderLineMargin:a5:dm', [1, 6], 'LeaderLineStyle:ef:dn', [Style.$, null], 'LeaderLineType:ao:dp', [LeaderLineType_$type, /*@__PURE__*/ enumGetBox(LeaderLineType_$type, 0)], 'LeaderLineVisibility:ek:dq', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'LegendItemBadgeTemplate::dr', [DataTemplate.$, null], 'LegendItemTemplate::ds', [DataTemplate.$, null], 'LegendLabelFormat:by:dt', [2, null], 'LegendLabelFormatSpecifiers:ah:du', [Array_$type, null], 'LegendLabelMemberPath:b1:dv', [2], 'LegendOthersLabelFormat:b3:dw', [2, null], 'LegendOthersLabelFormatSpecifiers:ai:dx', [Array_$type, null], 'Legend::dy', [IChartLegend_$type, null], 'OthersCategoryStyle:eg:dz', [Style.$, null], 'OthersCategoryText:b8:d0', [2, "Others"], 'OthersCategoryThreshold:a6:d1', [1, 3], 'OthersCategoryType:ap:d2', [OthersCategoryType_$type, /*@__PURE__*/ enumGetBox(OthersCategoryType_$type, 1)], 'OthersLabelFormat:cc:d3', [2, null], 'OthersLabelFormatSpecifiers:aj:d4', [Array_$type, null], 'Outlines:al:d5', [BrushCollection.$, null], 'RadiusFactor:a7:d6', [1, 0.9], 'SelectedStyle:eh:d7', [Style.$, null], 'StartAngle:a8:d8', [1, 0], 'ToolTip::d9', [4, null], 'ToolTipStyle:ej:ea', [Style.$, null], 'ValueMemberPath:cp:eb', [2, null]]);
    ...
    class RingControl extends Control {
        ...
        an() {
            ...
            for (let c of fromEnum(this.ao)) {
                ...
                if ((d.width != this.ai.q.width || d.height != this.ai.q.height) && d.a0.r()) {
            ...
            switch (b.propertyName) {
                ...
                case "LabelsPosition":
                    for (let e = 0; e < this.f.count; e++) {
                        this.f._inner[e].aw = EnumUtil.getEnumValue(LabelsPosition_$type, b.newValue);
                    }
                    break;
                case "LabelTemplate":
                ...
                case "LeaderLineType":
                    for (let k = 0; k < this.f.count; k++) {
                        this.f._inner[k].ax = EnumUtil.getEnumValue(LeaderLineType_$type, b.newValue);
                    }
                    break;
                ...
                case "OthersCategoryType":
                    for (let n = 0; n < this.f.count; n++) {
                        this.f._inner[n].ay = EnumUtil.getEnumValue(OthersCategoryType_$type, b.newValue);
                    }
                    break;
