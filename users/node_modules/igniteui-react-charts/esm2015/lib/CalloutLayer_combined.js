...
export let CalloutLayer = /*@__PURE__*/ (() => {
    class CalloutLayer extends AnnotationLayer {
        ...
        p3(a) {
            ...
            let c = this.qt != null ? this.qt : this.m8.cg(a.b.series);
            let d = this.qw != null ? this.qw : this.m8.cj();
            let e = this.qv != null ? this.qv : this.m8.ci();
            let f = this.qu != null ? this.qu : this.m8.ch(a.b.series);
        ...
        oa() {
            ...
            for (let b = 0; b < this.n9.count; b++) {
                ...
                if (this.n9._inner[b].c == null) {
                    ...
                    let d = this.m8.cl(this.oo(this.n9._inner[b]), this.n9._inner[b].b.backgroundPadding);
                    c.k = d.height / 2;
                    c.l = d.width / 2;
                }
        ...
        pz(a, b, c) {
            ...
            if (a.ch(this.n7, this.n2, this.ok)) {
                ...
                for (let f = 0; f < this.n7.count; f++) {
                    ...
                    let n = l.xValue;
                    let o = l.yValue;
                    if (this.oi(n) != this.oi(g.b)) {
                        l.xValue = g.b;
                    }
                    if (this.oi(o) != this.oi(g.c)) {
                        l.yValue = g.c;
                    }
                    l.series = a;
                    let p = false;
                    ...
                    if (k.c == null) {
                        ...
                        k.c = t;
                        let u = this.m8.cl(this.oo(k), k.b.backgroundPadding);
                        t.k = u.height / 2;
                        t.l = u.width / 2;
                    }
                    let v = this.nr(k);
                    if (v == null || v.b < this.lz.left || v.b > this.lz.right || v.c < this.lz.top || v.c > this.lz.bottom) {
                        continue;
                    }
                    c.add(k);
                }
...
export let CalloutLayerView = /*@__PURE__*/ (() => {
    class CalloutLayerView extends AnnotationLayerView {
        ...
        b9() {
            let a = this.b5();
            if (isNaN_(this.b8)) {
                let b = FontUtil.getCurrentFontHeight(this.e.bs.bn.i.ae, a);
                this.b8 = b;
            }
            return this.b8;
        }
