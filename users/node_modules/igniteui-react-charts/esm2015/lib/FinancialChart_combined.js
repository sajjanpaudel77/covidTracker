    ...
    class FinancialChart extends XYChart {
        ...
        dj() {
            let a = ((() => {
                ...
                $ret.volumeChart = this.volumeChart == null ? null : this.volumeChart.ok();
                $ret.toolbar = this.py == null ? null : this.py.aj();
                $ret.zoomChart = this.zoomSliderChart == null ? null : this.zoomSliderChart.ok();
                return $ret;
            })());
            if (this.indicatorCharts != null) {
