...
export let FinancialSeries = /*@__PURE__*/ (() => {
    class FinancialSeries extends Series {
        ...
        li(a, b, c) {
            return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.ej), (d, e) => this.ff(d, e, this.l9, runOn(this, this.nz), this.m2), (d, e) => this.fd(d, e, this.l9, runOn(this, this.nz), this.m2));
        }
        lk(a, b, c) {
            return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.el), (d, e) => this.ff(d, e, this.l9, runOn(this, this.nz), this.m3), (d, e) => this.fd(d, e, this.l9, runOn(this, this.nz), this.m3));
        }
        ph(a, b, c) {
            return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.n2), (d, e) => this.ff(d, e, this.l9, runOn(this, this.nz), this.m4), (d, e) => this.fd(d, e, this.l9, runOn(this, this.nz), this.m4));
        }
        pg(a, b, c) {
            return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.n1), (d, e) => this.ff(d, e, this.l9, runOn(this, this.nz), this.m1), (d, e) => this.fd(d, e, this.l9, runOn(this, this.nz), this.m1));
        }
        pi(a, b, c) {
        ...
        *_no() {
            ...
            if (!a) {
                if (this.nj && this.l9.i$b != null) {
                    ...
                    let e = this.l9.i$b;
                    for (let f = 0; f < d; ++f) {
                        yield (this.m2.item(e.item(f)) + this.m3.item(e.item(f)) + this.m1.item(e.item(f))) / 3;
                    }
                }
                else {
                    let g = this.bz.count;
                    for (let h = 0; h < g; ++h) {
                        yield (this.m2.item(h) + this.m3.item(h) + this.m1.item(h)) / 3;
                    }
                }
            }
        }
        ...
        *_nn() {
            if (this.nj && this.l9.i$b != null) {
                ...
                let b = this.l9.i$b;
                if (a > 0) {
                    yield this.n5(this.m2.item(b.item(0)) - this.m3.item(b.item(0)));
                }
                for (let c = 1; c < a; ++c) {
                    yield Math.max(this.n5(this.m2.item(b.item(c)) - this.m3.item(b.item(c))), Math.max(this.n5(Math.abs(this.m2.item(b.item(c)) - this.m1.item(b.item(c - 1)))), this.n5(Math.abs(this.m3.item(b.item(c)) - this.m1.item(b.item(c - 1))))));
                }
            }
            else {
                let d = this.m2.count;
                if (d > 0) {
                    yield this.n5(this.m2.item(0) - this.m3.item(0));
                }
                for (let e = 1; e < d; ++e) {
                    yield Math.max(this.n5(this.m2.item(e) - this.m3.item(e)), Math.max(this.n5(Math.abs(this.m2.item(e) - this.m1.item(e - 1))), this.n5(Math.abs(this.m3.item(e) - this.m1.item(e - 1)))));
                }
            }
        }
        nn() {
        ...
        *_nm() {
            if (this.nj && this.l9.i$b != null) {
                ...
                let b = this.l9.i$b;
                if (a > 0) {
                    yield this.n5(this.m3.item(b.item(0)));
                }
                for (let c = 1; c < a; c++) {
                    yield Math.min(this.n5(this.m3.item(b.item(c))), this.n5(this.m1.item(b.item(c - 1))));
                }
            }
            else {
                let d = this.m3.count;
                if (d > 0) {
                    yield this.n5(this.m3.item(0));
                }
                for (let e = 1; e < d; e++) {
                    yield Math.min(this.n5(this.m3.item(e)), this.n5(this.m1.item(e - 1)));
                }
            }
        }
        nm() {
        ...
        getHighColumnAsArray() {
            ...
            if (this.l9 != null && typeCast(ISortingAxis_$type, this.l9) !== null) {
                ...
                let a = new List$1(Number_$type, 2, this.m2.count);
                let b = this.l9.i$b;
                let c = this.m2.asArray();
                for (let d = 0; d < b.count; d++) {
                    a.add(c[b._inner[d]]);
                }
                this.nv = a;
        ...
        ml(a, b) {
            let c = this.nt(this.m4);
            let d = this.nt(this.m1);
            let e = this.nt(this.m2);
            let f = this.nt(this.m3);
