...
export let PieChartBase = /*@__PURE__*/ (() => {
    class PieChartBase extends Control {
        constructor() {
            ...
            this.bf = null;
            this.bg = null;
            this.ar = new IndexCollection();
            this.as = new IndexCollection();
            this.ci = NaN;
            this.ch = 1;
            ...
            this.a4 = (b, c) => this.fu(b, c.propertyName, c.oldValue, c.newValue);
            this.cd = (b, c) => {
                this.f1();
                this.f0();
            };
            ...
            this.propertyUpdated = delegateCombine(this.propertyUpdated, this.a4);
            ...
            this.bo = ((() => {
                ...
                $ret.create = runOn(this.a0, this.a0.g);
                $ret.activate = runOn(this.a0, this.a0.be);
                $ret.disactivate = runOn(this.a0, this.a0.bg);
                $ret.destroy = runOn(this.a0, this.a0.bf);
                return $ret;
            })());
            this.bn = ((() => {
                let $ret = new Pool$1(PieLabel.$);
                $ret.create = runOn(this.a0, this.a0.d);
                $ret.activate = runOn(this.a0, this.a0.ar);
                $ret.disactivate = runOn(this.a0, this.a0.at);
                $ret.destroy = runOn(this.a0, this.a0.as);
                return $ret;
            })());
            this.a3 = new PieChartSliceSelector(this);
        ...
        f2(a) {
            ...
            let b = this.a0.b2.width;
            let c = this.a0.b2.height;
            let d = a.count;
        ...
        fr() {
            ...
            for (let b = 0; b < this.bm.count; b++) {
                ...
                let e = this.ay == 1 ? c / this.c2 : c;
                let f = this.ay == 1 ? this.cw / 100 : this.cw;
                let g = true;
                if (e <= f && g) {
                    this.cx = this.cx + c;
                    this.b9.add(b);
        ...
        fs() {
            ...
            if (this.bi == null || this.bi.count == 0 || this.aw == 0) {
                this.bn.count = 0;
            }
            let a = this.ca.count;
            if (this.b9.count > 0) {
            ...
            for (let c = 0; c < a; c++) {
                ...
                if (c == a - 1 && this.b9.count > 0) {
                    f = this.eg;
                    e = true;
                    if (this.b0() || this.am != null || this.ap != null) {
                        let h = ((() => {
                    ...
                    if (this.b0() || this.am != null || this.ap != null) {
                        ...
                        if ((this.am != null && !e) || (this.ap != null && e)) {
                            if (e) {
                                formattedLabel_ = this.ap.i(k);
                            }
                            else {
                                formattedLabel_ = this.am.i(k);
                            }
                        }
                        else {
                            formattedLabel_ = this.a1(k);
                        }
        ...
        fz() {
            let a = this.a0.b2.width;
            let b = this.a0.b2.height;
            if (b == 0 || a == 0) {
                return;
            }
            if (this.bn.a.count == 0 || this.aw == 0) {
                this.bn.count = 0;
                return;
            }
            ...
            for (let s of fromEnum(e)) {
                this.a0.bm(s, s.ao.x, s.ao.y);
            }
            for (let t of fromEnum(f)) {
                this.a0.bm(t, t.ao.x, t.ao.y);
            }
            for (let u of fromEnum(c)) {
                this.a0.bm(u, u.ao.x, u.ao.y);
                if (u.ah.ai.ax == 0) {
                    u.am();
                }
                else {
        ...
        f0() {
            ...
            for (let a of fromEnum(this.bo.a)) {
                ...
                let f = b.content;
                if (this.b1() || this.an != null || this.ao != null) {
                    let g = null;
                    if (this.b1()) {
                        g = this.a2(b.content);
                    }
                    if (this.an != null && !f.isOthersSlice) {
                        g = this.an.i(b.content);
                    }
                    if (this.ao != null && f.isOthersSlice) {
                        g = this.ao.i(b.content);
                    }
                    if (g != null) {
        ...
        fu(a, b, c, d) {
            switch (b) {
                ...
                case PieChartBase.$$p[16]:
                    this.bn.c(runOn(this.a0, this.a0.bl));
                    this.fz();
                    break;
        ...
        f9(a, b, c) {
            ...
            let d = new SliceClickEventArgs(a, this.a0.ae(b));
            this.fp(this, d);
            if (!c) {
                this.a0.bn(a, b);
            }
        ...
        b4(a, b) {
            let c = new LabelClickEventArgs(a, this.a0.ae(b));
            this.fi(this, c);
        ...
        be() {
            return FontUtil.toFontInfo(this.a0.c.n, this.ev);
        }
        resolveLegendIndex() {
            return -1;
        }
    ...
    PieChartBase.gm = /*@__PURE__*/ DependencyProperty.i("InnerExtent", Number_$type, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(2, 0, (a, b) => a.fw("InnerExtent", b.oldValue, b.newValue)));
    PieChartBase.gw = /*@__PURE__*/ DependencyProperty.i("LabelTemplate", DataTemplate.$, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(2, null, (a, b) => a.fw("LabelTemplate", b.oldValue, b.newValue)));
    PieChartBase.hh = /*@__PURE__*/ DependencyProperty.i("SelectedItem", Base.$, PieChartBase.$, /*@__PURE__*/ new PropertyMetadata(1, (a, b) => {
    ...
    PieChartBase.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, PieChartBase, 'fw', ['AllowSliceExplosion:bx:gf', [0, true], 'AllowSliceSelection:by:gg', [0, true], 'Brushes:ak:gh', [BrushCollection.$, null], 'ExplodedRadius:co:gi', [1, 0.2], 'FastItemsSource:bd:gj', [FastItemsSource.$], 'FormatLabel:a1:gk', [Delegate_$type], 'FormatLegendLabel:a2:gl', [Delegate_$type], 'IsSurfaceInteractionDisabled:b3:gn', [0, false], 'ItemsSource::go', [IEnumerable_$type, null], 'LabelExtent:cu:gp', [1, 10], 'LabelFormat:dq:gq', [2, null], 'LabelFormatSpecifiers:ag:gr', [Array_$type, null], 'LabelInnerColor:hp:gs', [Brush.$, null], 'LabelMemberPath:du:gt', [2], 'LabelOuterColor:hq:gu', [Brush.$, null], 'LabelsPosition:aw:gv', [LabelsPosition_$type, /*@__PURE__*/ enumGetBox(LabelsPosition_$type, 1)], 'LeaderLineMargin:cv:gx', [1, 6], 'LeaderLineStyle:hy:gy', [Style.$, null], 'LeaderLineType:ax:gz', [LeaderLineType_$type, /*@__PURE__*/ enumGetBox(LeaderLineType_$type, 0)], 'LeaderLineVisibility:h2:g0', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'LegendItemBadgeTemplate::g1', [DataTemplate.$, null], 'LegendItemTemplate::g2', [DataTemplate.$, null], 'LegendLabelFormat:d6:g3', [2, null], 'LegendLabelFormatSpecifiers:ah:g4', [Array_$type, null], 'LegendLabelMemberPath:d9:g5', [2], 'LegendOthersLabelFormat:eb:g6', [2, null], 'LegendOthersLabelFormatSpecifiers:ai:g7', [Array_$type, null], 'Legend::g8', [IChartLegend_$type, null], 'OthersCategoryStyle:hz:g9', [Style.$, null], 'OthersCategoryText:eg:ha', [2, "Others"], 'OthersCategoryThreshold:cw:hb', [1, 3], 'OthersCategoryType:ay:hc', [OthersCategoryType_$type, /*@__PURE__*/ enumGetBox(OthersCategoryType_$type, 1)], 'OthersLabelFormat:ek:hd', [2, null], 'OthersLabelFormatSpecifiers:aj:he', [Array_$type, null], 'Outlines:al:hf', [BrushCollection.$, null], 'RadiusFactor:cz:hg', [1, 0.9], 'SelectedStyle:h0:hi', [Style.$, null], 'SelectionMode:bb:hj', [SliceSelectionMode_$type, /*@__PURE__*/ enumGetBox(SliceSelectionMode_$type, 1)], 'StartAngle:c1:hk', [1, 0], 'SweepDirection:hr:hl', [SweepDirection_$type, /*@__PURE__*/ enumGetBox(SweepDirection_$type, 1)], 'ToolTip:c8:hm', [4, null], 'ToolTipStyle:h1:hn', [Style.$, null], 'ValueMemberPath:e0:ho', [2, null]]);
    return PieChartBase;
})();
/**
 * @hidden
...
export let PieChartBaseView = /*@__PURE__*/ (() => {
    class PieChartBaseView extends Base {
        ...
        bl(a) {
            if ((this.a.ax != 0 && a.aq != null) || (this.a.ax == 0 && a.ap != null)) {
                return;
            }
            if (this.a.ax == 0) {
                a.aq = null;
