...
export let PolarBase = /*@__PURE__*/ (() => {
    class PolarBase extends MarkerSeries {
        ...
        od(a, b) {
            ...
            b.cr.k = this.m8.lq;
            b.cr.j = this.m8.lp;
            b.cr.l = (i, j) => this.m9.c(i, j, c, d, Math.cos);
            b.cr.m = (i, j) => this.m9.d(i, j, c, d, Math.sin);
            ...
            b.cr.n(a.n, this.nj, i, k, this.nw, runOn(this.m7, this.m7.getScaledAngle), runOn(this.m8, this.m8.lw), ((() => {
