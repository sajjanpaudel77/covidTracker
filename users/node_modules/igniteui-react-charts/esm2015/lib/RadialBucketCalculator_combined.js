...
export let RadialBase = /*@__PURE__*/ (() => {
    class RadialBase extends MarkerSeries {
        constructor() {
            ...
            this.m7 = null;
            this.nc = new SeriesRenderer$2(RadialFrame.$, RadialBaseView.$, 1, runOn(this, this.nn), runOn(this, this.no), runOn(this, this.ca), runOn(this, this.jm), runOn(this, this.nm), (a) => this.m8.co.e(this.eu));
        }
        iv(a) {
            super.iv(a);
            this.m8 = a;
    ...
    RadialBase.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, RadialBase, 'raisePropertyChanged', ['AngleAxis:m4:np', [CategoryAngleAxis.$, null], 'ClipSeriesToBounds:nf:nq', [0, false], 'ValueAxis:m6:nr', [NumericRadiusAxis.$, null]]);
    return RadialBase;
})();
/**
 * @hidden
