...
export let RangeCategorySeries = /*@__PURE__*/ (() => {
    class RangeCategorySeries extends CategorySeries {
        ...
        set lowColumn(a) {
            if (this.o3 != a) {
                let b = this.o3;
                this.o3 = a;
                this.raisePropertyChanged("LowColumn", b, this.o3);
            }
        }
        get highColumn() {
            return this.o2;
    ...
    RangeCategorySeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, RangeCategorySeries, 'raisePropertyChanged', ['HighMemberPath:o7:pd', [2, null], 'LowMemberPath:pa:pe', [2, null]]);
