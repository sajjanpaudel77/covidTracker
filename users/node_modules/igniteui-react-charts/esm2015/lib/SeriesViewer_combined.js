...
export let SeriesViewer = /*@__PURE__*/ (() => {
    class SeriesViewer extends Control {
        ...
        be(a) {
            let b = this.bn.j != null && this.bn.j.ai ? this.bf : this.bd;
            if (b != 3) {
                return b;
            }
            return this.bn.k(a);
    ...
    SeriesViewer.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, SeriesViewer, 'ji', ['ActualPlotAreaBorderBrush:l5:kz', [Brush.$, null], 'CircleMarkerTemplate:ko:k1', [DataTemplate.$, null], 'CrosshairVisibility:m9:k2', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 0)], 'DefaultInteraction:bd:k3', [InteractionState_$type, /*@__PURE__*/ enumGetBox(InteractionState_$type, 3)], 'DiamondMarkerTemplate:kp:k4', [DataTemplate.$, null], 'DragModifier:l1:k5', [ModifierKeys_$type, /*@__PURE__*/ enumGetBox(ModifierKeys_$type, 2)], 'HexagonMarkerTemplate:kq:k6', [DataTemplate.$, null], 'HexagramMarkerTemplate:kr:k7', [DataTemplate.$, null], 'HighlightingTransitionDuration:e5:k8', [1, 300], 'IsPagePanningAllowed:cy:k9', [0, true], 'IsSurfaceInteractionDisabled:cz:la', [0, false], 'OverviewPlusDetailPaneVisibility:na:lc', [Visibility_$type, /*@__PURE__*/ enumGetBox(Visibility_$type, 1)], 'PanModifier:l2:ld', [ModifierKeys_$type, /*@__PURE__*/ enumGetBox(ModifierKeys_$type, 4)], 'PentagonMarkerTemplate:ks:le', [DataTemplate.$, null], 'PentagramMarkerTemplate:kt:lf', [DataTemplate.$, null], 'PlotAreaBackground:me:lg', [Brush.$, null], 'PlotAreaBorderBrush:mf:lh', [Brush.$, null], 'PreferHigherResolutionTiles:db:li', [0, false], 'PyramidMarkerTemplate:ku:lj', [DataTemplate.$, null], 'RightButtonDefaultInteraction:bf:lk', [InteractionState_$type, /*@__PURE__*/ enumGetBox(InteractionState_$type, 3)], 'SquareMarkerTemplate:kv:ll', [DataTemplate.$, null], 'SubtitleHorizontalAlignment:lz:lm', [HorizontalAlignment_$type, /*@__PURE__*/ enumGetBox(HorizontalAlignment_$type, 1)], 'Subtitle:gf:ln', [2, null], 'TetragramMarkerTemplate:kw:lo', [DataTemplate.$, null], 'TitleHorizontalAlignment:l0:lp', [HorizontalAlignment_$type, /*@__PURE__*/ enumGetBox(HorizontalAlignment_$type, 1)], 'Title:gr:lq', [2, null], 'TriangleMarkerTemplate:kx:lr', [DataTemplate.$, null], 'UseTiledZooming:dj:ls', [0, false], 'WindowPositionHorizontal:ev:lt', [1, NaN], 'WindowPositionVertical:ew:lu', [1, NaN], 'WindowRectMinWidth:ex:lv', [1, 0.0001], 'WindowRect:m6:lw', [Rect.$, /*@__PURE__*/ new Rect(0, 0, 0, 1, 1)], 'WindowResponse:ba:lx', [WindowResponse_$type, /*@__PURE__*/ enumGetBox(WindowResponse_$type, 1)], 'ZoomTileCacheSize:e6:ly', [1, 30]]);
    return SeriesViewer;
})();
/**
 * @hidden
...
export let SeriesViewerView = /*@__PURE__*/ (() => {
    class SeriesViewerView extends Base {
        ...
        b0() {
            ...
            LabelPanelArranger.d(j, u, this.e2, (v, w) => {
                if (!v.co.equals1(w)) {
                    v.co = w;
                    v.ac.a4.ad();
                }
        ...
        ed() {
            if (this.n.bi != null && !this.e2.isEmpty) {
                let a = this.n.bi;
                let b = (this.n.ca) ? this.e2.width : Number.POSITIVE_INFINITY;
                let c = (this.n.ca) ? this.e2.height : Number.POSITIVE_INFINITY;
...
export let Axis = /*@__PURE__*/ (() => {
    ...
    Axis.d7 = 7;
    Axis.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, Axis, 'g5', ['ActualMajorStroke:io:hq', [Brush.$], 'ActualMinorStroke:ip:hr', [Brush.$], 'ActualStroke:iq:hs', [Brush.$], 'CrossingAxis:ai:ht', [Axis.$], 'CrossingValue:e4:hu', [4, null], 'EnhancedIntervalMinimumCharacters:ez:hv', [1, -1], 'FormatLabel:at:hw', [Delegate_$type], 'IsDisabled:b8:hx', [0, false], 'IsInverted:ca:hy', [0, false], 'LabelFormat:fo:hz', [2, null], 'LabelFormatSpecifiers:ag:h0', [Array_$type, null], 'Label:e9:h1', [4, null], 'LabelSettings:ay:h2', [AxisLabelSettings.$, null], 'MajorStrokeDashArray:iw:h3', [DoubleCollection.$], 'MajorStroke:ir:h4', [Brush.$], 'MajorStrokeThickness:d5:h5', [1, 1], 'MinorStrokeDashArray:ix:h6', [DoubleCollection.$], 'MinorStroke:is:h7', [Brush.$], 'MinorStrokeThickness:d8:h8', [1, 1], 'Strip:it:h9', [Brush.$], 'StrokeDashArray:iy:ia', [DoubleCollection.$], 'Stroke:iu:ib', [Brush.$], 'StrokeThickness:ep:ic', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'TickLength:eq:id', [1, NaN], 'TickStrokeDashArray:iz:ie', [DoubleCollection.$], 'TickStroke:iv:ig', [Brush.$], 'TickStrokeThickness:er:ih', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'Title:gc:ii', [2], 'TitleSettings:be:ij', [TitleSettings.$, null]]);
    return Axis;
})();
/**
 * @hidden
...
export let AxisLabelPanelBase = /*@__PURE__*/ (() => {
    class AxisLabelPanelBase extends Panel {
        constructor() {
            ...
            this.a3 = new List$1(LabelPosition.$, 0);
        ...
        bx(a) {
            ...
            let b = Math.abs(this.bi() - 0) > 1E-06;
            let c = this.cn();
            let d = c.left + (c.width / 2);
            let e = c.top + (c.height / 2);
            let f = this.bl() + this.ae.t() + this.ae.u();
            let g = this.bj() + this.ae.v() + this.ae.s();
            let h = f / 2;
            let i = g / 2;
        ...
        cs(a) {
            ...
            let c = (this.ac == null || this.a6 <= 0 || isNaN_(this.a6)) ? 50 : this.a6;
    ...
    AxisLabelPanelBase.cj = /*@__PURE__*/ DependencyProperty.i("Extent", Number_$type, AxisLabelPanelBase.$, /*@__PURE__*/ new PropertyMetadata(2, 50, (a, b) => a.a6 = b.newValue));
...
export let HorizontalAxisLabelPanelBase = /*@__PURE__*/ (() => {
    class HorizontalAxisLabelPanelBase extends AxisLabelPanelBase {
        ...
        az() {
            ...
            let h = 0;
            if (this.cw()) {
                h = ((() => { let i = this.bq(this.c2, a, b); a = i.p1; return i.ret; })());
            }
            if (this.an && !this.ar) {
                if (h > 0) {
                    if (this.ct.ay()) {
            ...
            if (this.an && this.cu()) {
                ...
                let j = this.c0();
                let k = this.cz();
                let l = this.a3.count > 1 ? this.a3._inner[1].c - this.a3._inner[0].c : i;
                let m = Math.abs(l * 0.8);
                let n = 0;
                let o = Math.abs(Math.atan(this.c2 / l) * 180 / Math.PI);
                let p = this.ae.p();
                let q = this.ae.q();
                for (let r = 0; r < a.count; r++) {
                    if (this.ak) {
                        if (r > 0 && r < a.count - 1) {
                            let s = this.a3.count > 1 ? this.a3._inner[r].c - (a._inner[r - 1].x + a._inner[r - 1].width) : i;
                            let t = this.a3.count > 1 ? a._inner[r + 1].x - this.a3._inner[r].c : i;
                            m = Math.abs(Math.min(Math.abs(s * 2), Math.abs(t * 2)) * 0.8);
                        }
                        else {
                            if (r == 0) {
                                let u = this.a3.count > 1 ? a._inner[r + 1].x - this.a3._inner[r].c : i;
                                m = Math.abs((l * 2) * 0.8);
                            }
                            if (r == a.count - 1) {
                                let v = this.a3.count > 1 ? this.a3._inner[r].c - (a._inner[r - 1].x + a._inner[r - 1].width) : i;
                                m = Math.abs((v * 2) * 0.8);
                            }
                        }
                    }
                    ...
                    let z = a._inner[r];
                    if (this.aq && y) {
                        let aa = this.bn(this.a4._inner[r]);
                    ...
                    let ab = typeCast(TextBlock.$, this.a4._inner[r]);
                    if (ab != null) {
                        let ac = this.bt(r, ab, m, p, q);
                        if (this.as) {
                            ab.height = k;
                        }
        ...
        c7(a, b, c) {
            ...
            for (let n = 0; n < this.a4.count; n++) {
                if (this.a3 == null || n >= this.a3.count) {
                    break;
                }
                let o, p, q, r, s, t;
                let u = this.a4._inner[n];
                s = this.bd(u);
                t = this.bc(u);
                r = s + this.ae.p() + this.ae.q();
                q = t + h + i;
                let v = this.a3._inner[n].a;
                if (this.aq) {
        ...
        c6(a) {
            let b = a * (Math.PI / 180);
            let c = Math.abs(this.c4 * Math.sin(b)) + Math.abs(this.c3 * Math.cos(b));
        ...
        cc(a, b) {
            ...
            let h = AngleSimplifier.a(this.be());
            let i = ((() => {
                let $ret = new RotateTransform();
                $ret.j = h;
                $ret.k = e;
        ...
        cz() {
            let a = ((this.c0() - this.ae.r()) - this.ae.o());
            if (a < 0) {
                a = 0;
            }
            return a;
...
export let VerticalAxisLabelPanel = /*@__PURE__*/ (() => {
    class VerticalAxisLabelPanel extends AxisLabelPanelBase {
        ...
        cw() {
            let a = ((this.cy() - this.ae.p()) - this.ae.q());
            if (a < 0) {
                a = 0;
            }
            return a;
        ...
        az() {
            ...
            for (let h = 0; h < this.a4.count; h++) {
                let i = this.a4._inner[h];
                let j = this.a3._inner[h].a;
                let k = this.bc(i);
                let l = this.bd(i);
                let m = k + c + e;
                let n = l + b + d;
                let o = this.co.left + f;
                let p = this.a3._inner[h].c - m / 2;
                if (j) {
                    let q = this.a7;
            ...
            if (!w) {
                let x = this.co.height;
                let y = this.cy();
                let z = y;
                let aa = this.a3.count > 1 ? Math.abs(this.a3._inner[1].c - this.a3._inner[0].c) : x;
                let ab = Math.abs(Math.asin(aa / this.c2) * (180 / Math.PI));
                let ac = (s >= ab && s <= 180 - ab) || (s - 180 >= ab && s - 180 <= 180 - ab);
                for (let ad = 0; ad < a.count; ad++) {
                    if (this.aq) {
                        let ae = s * (Math.PI / 180);
                        let af = this.bn(this.a4._inner[ad]);
                    ...
                    let ai = typeCast(TextBlock.$, this.a4._inner[ad]);
                    if (ai != null) {
                        let aj = this.bt(ad, ai, z, b, d);
        ...
        c3(a, b, c) {
            let d = a * (Math.PI / 180);
            let e = Math.abs(this.c1 * Math.cos(d)) + Math.abs(this.c0 * Math.sin(d));
            let f = this.bm();
        ...
        cc(a, b) {
            ...
            let f = AngleSimplifier.a(this.be());
            let g = ((() => {
                let $ret = new RotateTransform();
                $ret.j = f;
                $ret.k = c;
...
export let XamDataChart = /*@__PURE__*/ (() => {
    class XamDataChart extends SeriesViewer {
        constructor() {
            ...
            let a = this.axes;
            a.collectionChanged = delegateCombine(a.collectionChanged, runOn(this, this.o8));
            let b = this.axes;
            b.collectionResetting = delegateCombine(b.collectionResetting, runOn(this, this.o9));
        }
        get XSRP() {
            if (this._xsr == null) {
        ...
        mt(a) {
            ...
            let c = new Rect(0, a.left + this.oe, a.top + this.og, a.width - this.oe - this.of, a.height - this.og - this.od);
            return c;
        }
        mz() {
            let a = this.m5;
    ...
    XamDataChart.oc = 0;
    XamDataChart.ob = 0;
    XamDataChart.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, XamDataChart, 'ji', ['AlignsGridLinesToPixels:np:pf', [0, true], 'AutoExpandMarginExtraPadding:n9:pg', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'AutoExpandMarginMaximumValue:oa:ph', [1, 60], 'Brushes:nb:pi', [BrushCollection.$, null], 'DefaultAxisMajorStroke:pz:pj', [Brush.$, null], 'DefaultAxisMinorStroke:p0:pk', [Brush.$, null], 'DefaultAxisStroke:p1:pl', [Brush.$, null], 'GridMode:ni:pm', [GridMode_$type, /*@__PURE__*/ enumGetBox(GridMode_$type, 2)], 'HorizontalZoomable:ns:pn', [0, false], 'IsHorizontalZoomEnabled:nt:po', [0, false], 'IsSquare:nv:pp', [0, false], 'IsVerticalZoomEnabled:nw:pq', [0, false], 'MarkerBrushes:nc:pr', [BrushCollection.$, null], 'MarkerOutlines:nd:ps', [BrushCollection.$, null], 'Outlines:ne:pt', [BrushCollection.$, null], 'ShouldAutoExpandMarginForInitialLabels:nx:pu', [0, false], 'ShouldClipGridlines:ny:pv', [0, true], 'VerticalZoomable:nz:pw', [0, false], 'WindowScaleHorizontal:oh:px', [1, NaN], 'WindowScaleVertical:oi:py', [1, NaN]]);
    return XamDataChart;
})();
/**
 * @hidden
...
export let Series = /*@__PURE__*/ (() => {
    class Series extends Control {
        ...
        jw() {
            let a = typeCast(ContentControl.$, this.jv);
...
export let MarkerSeries = /*@__PURE__*/ (() => {
    ...
    MarkerSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, MarkerSeries, 'raisePropertyChanged', ['ActualMarkerBrush:mz:mp', [Brush.$], 'ActualMarkerOutline:m0:mq', [Brush.$], 'ActualMarkerTemplate:ml:mr', [DataTemplate.$, null], 'MarkerOutline:m2:mt', [Brush.$], 'MarkerStyle:m3:mu', [Style.$], 'MarkerTemplate:mn:mv', [DataTemplate.$, null], 'MarkerThickness:l7:mw', [1, /*@__PURE__*/ DeviceUtils.g(2)], 'MarkerType:l2:mx', [MarkerType_$type, /*@__PURE__*/ enumGetBox(MarkerType_$type, 1)], 'UseLightweightMarkers:l6:my', [0, false]]);
    return MarkerSeries;
})();
/**
 * @hidden
...
export let XamDataChartView = /*@__PURE__*/ (() => {
    class XamDataChartView extends SeriesViewerView {
        ...
        dx() {
            ...
            this.fj = f.i;
            this.fg = c;
            for (let k of fromEnum(this.fe.series)) {
                k.jo();
            }
            this.fh = d;
        }
