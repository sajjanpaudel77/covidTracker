...
var AnchoredRadialSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function AnchoredRadialSeries() {
        ...
        _this.nu = null;
        _this.ny = null;
        _this.os = { $type: Point_$type, x: 0, y: 0 };
        _this.nw = null;
        _this.nv = null;
        _this.nw = new RadialFrame(3);
        _this.nu = new CategoryLineRasterizer();
        return _this;
    }
    ...
    AnchoredRadialSeries.prototype.en = function (a, b, c) {
        ...
        var e = this.n4(this.m4, this.bi.bs, this.bi.br, d);
    ...
    AnchoredRadialSeries.prototype.lm = function (a, b, c) {
        ...
        if (!b && this.m4 != null) {
            var h = this.fe(a, c);
            var i = this.fc(a, c);
            var j = this.n4(this.m4, this.bi.bs, this.bi.br, d);
    ...
    Object.defineProperty(AnchoredRadialSeries.prototype, "nz", {
        get: function () {
            return this.ny;
        },
        set: function (a) {
    ...
    Object.defineProperty(AnchoredRadialSeries.prototype, "oo", {
        get: function () {
    ...
    AnchoredRadialSeries.prototype.get_n2 = function () {
        return false;
    };
    Object.defineProperty(AnchoredRadialSeries.prototype, "n2", {
        get: function () {
            return this.get_n2();
        },
        enumerable: true,
    ...
    AnchoredRadialSeries.prototype.n4 = function (a, b, c, d) {
        var e = 0;
    ...
    AnchoredRadialSeries.prototype.nn = function (a, b) {
        var _this = this;
        var c = b.bs;
        var d = b.br;
        ...
        l.ct.i = this.m6.lq;
        l.ct.h = this.m6.lp;
        l.ct.j = function (p, q) { return _this.n5(p, q, c, d); };
        l.ct.k = function (p, q) { return _this.n6(p, q, c, d); };
        var p = ((function () {
        ...
        l.ct.l(a.p, this.nx, this.nz, this.n8, function (r) { return _this.m4.getScaledAngle(r); }, function (r) { return _this.m6.lw(r); }, q, p);
        var r = true;
        if (this.n3(b)) {
            o--;
        }
    ...
    AnchoredRadialSeries.prototype.n3 = function (a) {
        var b = a;
        return !this.n2 && b.co.c == 0 && b.co.d == this.m4.j6;
    };
    AnchoredRadialSeries.prototype.ns = function (a, b, c) {
        var d = null;
        var e = c.bs;
        var f = c.br;
    ...
    AnchoredRadialSeries.prototype.n0 = function () {
        var a = this.bi.bs;
    ...
    AnchoredRadialSeries.prototype.od = function (a, b, c, d, e) {
        e.cu(a, b, c, d);
    };
    ...
    AnchoredRadialSeries.prototype.c9 = function (a) {
        ...
        var f = this.m6.lw(this.nz.item(d));
        if (isNaN_(f)) {
    ...
    AnchoredRadialSeries.of = DependencyProperty.i("ActualTrendLineBrush", Brush.$, AnchoredRadialSeries.$, new PropertyMetadata(2, null, function (a, b) { return a.raisePropertyChanged("ActualTrendLineBrush", b.oldValue, b.newValue); }));
    AnchoredRadialSeries.$$p = markDep(DependencyProperty, PropertyMetadata, AnchoredRadialSeries, 'raisePropertyChanged', ['ValueMemberPath:ob:on', [2, null], 'TrendLineType:nx:ol', [TrendLineType_$type, enumGetBox(TrendLineType_$type, 0)], 'TrendLineThickness:n7:ok', [1, 1.5], 'TrendLinePeriod:n8:oj', [1, 7], 'TrendLineZIndex:n9:om', [1, 1], 'TrendLineBrush:op:og', [Brush.$, null], 'TrendLineDashArray:oq:oh', [DoubleCollection.$], 'TrendLineDashCap:or:oi', [PenLineCap_$type, enumGetBox(PenLineCap_$type, 0)]]);
