...
var AngleAxisLabelPanel = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AngleAxisLabelPanel.prototype.b9 = function (a) {
        _super.prototype.b9.call(this, a);
        this.ct = a;
    };
    AngleAxisLabelPanel.prototype.ap = function (a, b) {
        if (!Extensions.b(b)) {
            return false;
        }
    ...
    AngleAxisLabelPanel.prototype.az = function () {
        var a = new List$1(Rect.$, 0);
        var b = new List$1(Boolean_$type, 0);
        if (this.a4.count != this.a3.count) {
            return a;
        }
        this.ct.ay(a, b);
        var c = false;
        ...
        if (c) {
            for (var d = 0; d < a.count; d++) {
                ...
                var f = this.a3._inner[d];
                var g = a._inner[d];
                var h = this.c0(f.c);
                var i = h.x - this.bd(e) / 2;
                var j = h.y - this.bc(e) / 2;
                g.x = i;
                g.y = j;
                a._inner[d] = g;
            }
    ...
    AngleAxisLabelPanel.prototype.cz = function () {
        var a;
        var b;
        b = this.ac;
        a = null;
        ...
        for (var d = 0; d < a.axes.count; d++) {
            ...
            if ((typeCast(NumericAngleAxis.$, e) !== null || typeCast(CategoryAngleAxis.$, e) !== null) && typeCast(AngleAxisLabelPanel.$, e.av) !== null && e.av.a4.count > 0 && (!e.b1()) && !e.b0() && (e.ai == null || this.ac.ai == null || e.ai.lq == b.ai.lq)) {
                c.add(e);
            }
        }
        var f = c.indexOf(b);
        ...
        if (f == 0) {
            ...
            g += c._inner[f - 1].av.ba;
            g += c._inner[f].av.ba * 2 + h;
        }
        return g;
    };
    ...
    AngleAxisLabelPanel.prototype.at = function (a) {
        return a == 4 || a == 5;
    };
...
var CategoryAngleAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryAngleAxis.prototype.au = function () {
        ...
        a.c0 = function (b) {
            ...
            return _this.l3(b, { $type: Point_$type, x: 0.5, y: 0.5 }, c, d, _this.av.ba);
        };
        return a;
    };
    ...
    CategoryAngleAxis.prototype.k5 = function () {
        ...
        b.b.c = function (c) {
            var e_1, _a;
            if ((_this.ay == null || _this.ay.visibility == 0) && _this.k8 != null && _this.le != c) {
...
var NumericAngleAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericAngleAxis.prototype.au = function () {
        ...
        a.c0 = function (b) {
            var c = _this.bh != null ? _this.bh.mr : Rect.empty;
            var d = !c.isEmpty ? _this.i8 : Rect.empty;
            return _this.lz(b, { $type: Point_$type, x: 0.5, y: 0.5 }, c, d, _this.av.ba);
        };
        return a;
    };
    ...
    NumericAngleAxis.prototype.jk = function () {
        ...
        a.b.c = function (b) {
            var e_5, _a;
            if ((_this.ay == null || _this.ay.visibility == 0) && _this.ll != null && _this.lo != b) {
...
var NumericRadiusAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericRadiusAxis.prototype.jk = function () {
        ...
        var a = _super.prototype.jk.call(this);
        a.b.c = function (b) {
            if ((_this.ay == null || _this.ay.visibility == 0) && _this.lk != null) {
                if ((_this.ay == null || (_this.ay.c == 4 || _this.ay.c == 5)) && _this.lo != b) {
                    _this.lo = b;
                    _this.av.a9 = b;
                    _this.bh.hu();
                }
...
var AngleAxisLabelPanelView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AngleAxisLabelPanelView.prototype.ay = function (a, b) {
        this.ax.cy = -1.7976931348623157E+308;
        this.ax.cv = -1.7976931348623157E+308;
        this.ax.cx = -1.7976931348623157E+308;
        this.ax.cw = -1.7976931348623157E+308;
        for (var c = 0; c < this.a.a4.count; c++) {
            var d = this.a.a4._inner[c];
            var e = this.a.a3._inner[c];
            var f = e.a;
            var g = this.ax.c0(e.c);
            var h = this.m(d);
            var i = this.l(d);
            ...
            var l = g.x - j / 2;
            var m = g.y - k / 2;
            this.ax.cx = Math.max(h, this.ax.cx);
            this.ax.cw = Math.max(i, this.ax.cw);
            this.ax.cy = Math.max(j, this.ax.cy);
            this.ax.cv = Math.max(k, this.ax.cv);
