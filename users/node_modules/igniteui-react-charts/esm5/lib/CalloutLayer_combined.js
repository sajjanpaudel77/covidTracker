...
var CalloutLayer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutLayer.prototype.p2 = function (a, b) {
        ...
        if (this.calloutLabelUpdating != null) {
            ...
            if (g.b != null && !Base.equalsStatic(g.b, f.b.text)) {
                var h = g.b;
    ...
    CalloutLayer.prototype.p3 = function (a) {
        ...
        var c = this.qt != null ? this.qt : this.m8.cg(a.b.series);
        var d = this.qw != null ? this.qw : this.m8.cj();
        var e = this.qv != null ? this.qv : this.m8.ci();
        var f = this.qu != null ? this.qu : this.m8.ch(a.b.series);
    ...
    CalloutLayer.prototype.oa = function () {
        ...
        for (var b = 0; b < this.n9.count; b++) {
            ...
            if (this.n9._inner[b].c == null) {
                ...
                var d = this.m8.cl(this.oo(this.n9._inner[b]), this.n9._inner[b].b.backgroundPadding);
                c.k = d.height / 2;
                c.l = d.width / 2;
            }
    ...
    CalloutLayer.prototype.pz = function (a, b, c) {
        ...
        if (a.ch(this.n7, this.n2, this.ok)) {
            ...
            var _loop_1 = function (f) {
                ...
                l.key = j;
                var m = false;
                if (this_1.n3.containsKey(k)) {
                    k = this_1.n3.item(k).c;
                    l = k.b;
                    m = d;
                }
                else {
                ...
                var n = l.xValue;
                var o = l.yValue;
                if (this_1.oi(n) != this_1.oi(g.b)) {
                    l.xValue = g.b;
                }
                if (this_1.oi(o) != this_1.oi(g.c)) {
                    l.yValue = g.c;
                }
                l.series = a;
                var p = false;
                ...
                if (m || p) {
                    if (this_1.calloutLabelUpdating != null) {
                        ...
                        if (q.b != null && !Base.equalsStatic(q.b, k.b.text)) {
                            var r = q.b;
                ...
                if (m || p) {
                    if (this_1.calloutContentUpdating != null) {
                        ...
                        if (s.a != null && s.a != k.b.content) {
                            k.b.content = s.a;
                        }
                    }
                    else {
                        if (h != null && h != k.b.content) {
                            k.b.content = h;
                        }
                    }
                }
                ...
                if (k.c == null) {
                    ...
                    k.c = t;
                    var u = this_1.m8.cl(this_1.oo(k), k.b.backgroundPadding);
                    t.k = u.height / 2;
                    t.l = u.width / 2;
                }
                var v = this_1.nr(k);
                if (v == null || v.b < this_1.lz.left || v.b > this_1.lz.right || v.c < this_1.lz.top || v.c > this_1.lz.bottom) {
                    return "continue";
                }
                c.add(k);
            };
            var this_1 = this;
            for (var f = 0; f < this.n7.count; f++) {
                _loop_1(f);
            }
        }
    };
    ...
    CalloutLayer.prototype.p1 = function (a, b) {
        ...
        for (c = 0; c < a.p.count; c++) {
            ...
            this.m8.ce(f, Math.min(a.r._inner[c], a.r._inner[c] + a.t._inner[c]), Math.min(a.s._inner[c], a.s._inner[c] + a.u._inner[c]));
            this.m8.cf(f, e, a.q._inner[c]);
...
var CalloutLayerView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutLayerView.prototype.b9 = function () {
        var a = this.b5();
        if (isNaN_(this.b8)) {
            var b = FontUtil.getCurrentFontHeight(this.e.bs.bn.i.ae, a);
            this.b8 = b;
        }
        return this.b8;
    };
    ...
    CalloutLayerView.prototype.ce = function (a, b, c) {
        a.d = b;
        a.e = c;
    };
    CalloutLayerView.prototype.cf = function (a, b, c) {
        a.i(this.e, b, c);
    };
    ...
    CalloutLayerView.prototype.cj = function () {
        return ((function () {
            var $ret = new Brush();
    ...
    CalloutLayerView.prototype.cd = function () {
        this.b8 = NaN;
    };
