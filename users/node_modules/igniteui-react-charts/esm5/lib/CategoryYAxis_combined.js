...
var CategoryYAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryYAxis.prototype.gr = function (a, b, c, d, e) {
        ...
        var j = e.a;
        var k = !i.isEmpty;
        var l = this.categoryMode == 0 ? this.j6 - 1 : this.j6;
        if (l < 0) {
            l = 0;
        }
        var m = i.top;
    ...
    Object.defineProperty(CategoryYAxis.prototype, "k7", {
        get: function () {
            return this.k5;
        },
        set: function (a) {
            if (this.k7 != a) {
                var b = this.k5;
                this.k5 = a;
                this.g5("ActualInterval", b, this.k7);
            }
        },
        enumerable: true,
        configurable: true
    ...
    CategoryYAxis.prototype.k9 = function (a, b, c) {
        var d = this.categoryMode == 0 ? this.j6 - 1 : this.j6;
        if (d < 0) {
            d = 0;
        }
    ...
    CategoryYAxis.prototype.getCategorySize = function (a, b, c) {
        var d = this.i6(b, c);
        return d.height / (this.j6 * a.height);
    };
