...
var DataChartVisualDataManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataChartVisualDataManager.prototype.b = function (a, b) {
        ...
        if (c.ep != null) {
            d = c.t();
            var h = this.a(c, c.ep, d);
            var i = { $type: Point_$type, x: 0, y: 0 };
            g = c.ep.l + e.b + e.e;
            var j = new ChartTitleVisualData();
            var k = c.e5();
            j.viewport = new RectData(k.left, k.top, k.width, g);
            j.textPlotArea = RectData.b(this.d(c.ep, a));
            j.textPlotArea = new RectData(c.ep.n, c.ep.o, c.ep.m, c.ep.l);
            f = j.height;
            j.appearance = AppearanceHelper.c(c.ep, h);
            var l = c.fd();
        ...
        if (c.eo != null) {
            d = c.s();
            var n = this.a(c, c.eo, d);
            var o = { $type: Point_$type, x: 0, y: f };
            var p = c.fc();
            var q = c.eo.l + p.b + p.e;
            var r = new ChartTitleVisualData();
            var s = c.e5();
            r.viewport = new RectData(s.left, s.top + g, s.width, q);
            r.textPlotArea = RectData.b(this.d(c.eo, a));
            r.appearance = AppearanceHelper.c(c.eo, n);
            var t = c.fc();
