...
var FinancialSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(FinancialSeries.prototype, "m4", {
        get: function () {
            return this.mz;
        },
        set: function (a) {
            if (this.mz != a) {
                var b = this.mz;
                this.mz = a;
                this.raisePropertyChanged("OpenColumn", b, this.mz);
            }
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FinancialSeries.prototype, "m2", {
        get: function () {
            return this.mx;
        },
        set: function (a) {
            if (this.mx != a) {
                var b = this.mx;
                this.mx = a;
                this.raisePropertyChanged("HighColumn", b, this.mx);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(FinancialSeries.prototype, "m6", {
        ...
        set: function (a) {
            if (this.m0 != a) {
                var b = this.m0;
                this.m0 = a;
                this.raisePropertyChanged("VolumeColumn", b, this.m0);
            }
        },
        enumerable: true,
        configurable: true
    ...
    FinancialSeries.prototype.fe = function (a, b) {
        return this.ff(a, b, this.l9, runOn(this, this.nz), new FinancialValueList(this.m4, this.m2, this.m3, this.m1, this.m6));
    };
    FinancialSeries.prototype.fc = function (a, b) {
        return this.fd(a, b, this.l9, runOn(this, this.nz), new FinancialValueList(this.m4, this.m2, this.m3, this.m1, this.m6));
    };
    ...
    FinancialSeries.prototype.en = function (a, b, c) {
        ...
        return this.ep(new FinancialValueList(this.m4, this.m2, this.m3, this.m1, this.m6), a, this.l9, f, e, runOn(this, this.nz), b, c);
    };
    FinancialSeries.prototype.ej = function (a, b, c) {
        var d = this.getEffectiveViewport1(this.bi);
        var e = this.n0(this.bi.bs, this.bi.br, d);
        var f = new ScalerParams(0, this.bi.bs, this.bi.br, this.l9.ca, d);
        return this.ep(this.m2, a, this.l9, f, e, runOn(this, this.nz), b, c);
    };
    ...
    FinancialSeries.prototype.n2 = function (a, b, c) {
        ...
        var e = this.n0(this.bi.bs, this.bi.br, d);
        var f = new ScalerParams(0, this.bi.bs, this.bi.br, this.l9.ca, d);
        return this.ep(this.m4, a, this.l9, f, e, runOn(this, this.nz), b, c);
    };
    ...
    FinancialSeries.prototype.li = function (a, b, c) {
        var _this = this;
        return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.ej), function (d, e) { return _this.ff(d, e, _this.l9, runOn(_this, _this.nz), _this.m2); }, function (d, e) { return _this.fd(d, e, _this.l9, runOn(_this, _this.nz), _this.m2); });
    };
    FinancialSeries.prototype.lk = function (a, b, c) {
        var _this = this;
        return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.el), function (d, e) { return _this.ff(d, e, _this.l9, runOn(_this, _this.nz), _this.m3); }, function (d, e) { return _this.fd(d, e, _this.l9, runOn(_this, _this.nz), _this.m3); });
    };
    FinancialSeries.prototype.ph = function (a, b, c) {
        var _this = this;
        return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.n2), function (d, e) { return _this.ff(d, e, _this.l9, runOn(_this, _this.nz), _this.m4); }, function (d, e) { return _this.fd(d, e, _this.l9, runOn(_this, _this.nz), _this.m4); });
    };
    FinancialSeries.prototype.pg = function (a, b, c) {
        var _this = this;
        return this.lo(a, b, c, this.n0(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi)), this.mu, this.l9, runOn(this, this.n1), function (d, e) { return _this.ff(d, e, _this.l9, runOn(_this, _this.nz), _this.m1); }, function (d, e) { return _this.fd(d, e, _this.l9, runOn(_this, _this.nz), _this.m1); });
    };
    ...
    FinancialSeries.prototype.m5 = function (a, b, c) {
        var d = this.bw(b);
        this.nk.addItem(d, b);
        this.nl.addItem(b, c);
        return d;
        ...
        switch (b) {
            ...
            case "FastItemsSource":
                ...
                if (typeCast(IFastItemsSource_$type, c) != null) {
                    this.oy(typeCast(IFastItemsSource_$type, c), this.m4);
                    this.oy(typeCast(IFastItemsSource_$type, c), this.m2);
                ...
                if (typeCast(IFastItemsSource_$type, d) != null) {
                    if (stringIsNullOrEmpty(this.op) == false) {
                        this.m4 = this.m5(typeCast(IFastItemsSource_$type, d), this.op, "OpenColumn");
                    }
                    if (stringIsNullOrEmpty(this.og) == false) {
                        this.m2 = this.m5(typeCast(IFastItemsSource_$type, d), this.og, "HighColumn");
                    }
                    if (stringIsNullOrEmpty(this.ol) == false) {
                        this.m3 = this.m5(typeCast(IFastItemsSource_$type, d), this.ol, "LowColumn");
                    }
                    if (stringIsNullOrEmpty(this.od) == false) {
                        this.m1 = this.m5(typeCast(IFastItemsSource_$type, d), this.od, "CloseColumn");
                    }
                    if (stringIsNullOrEmpty(this.ot) == false) {
                        this.m6 = this.m5(typeCast(IFastItemsSource_$type, d), this.ot, "VolumeColumn");
                    }
                }
                this.m8 = false;
            ...
            case FinancialSeries.$$p[6]:
                if (this.bz != null) {
                    this.oy(this.bz, this.m4);
                    this.m4 = this.m5(this.bz, this.op, "OpenColumn");
                }
                break;
            case "OpenColumn":
            ...
            case FinancialSeries.$$p[1]:
                if (this.bz != null) {
                    this.oy(this.bz, this.m2);
                    this.m2 = this.m5(this.bz, this.og, "HighColumn");
                }
                break;
            case "HighColumn":
                if (this.mu != null && !this.mu.cn() && !this.m8) {
            ...
            case FinancialSeries.$$p[4]:
                if (this.bz != null) {
                    ...
                    this.m3 = this.m5(this.bz, this.ol, "LowColumn");
                }
                break;
            case "LowColumn":
                if (this.mu != null && !this.mu.cn() && !this.m8) {
            ...
            case FinancialSeries.$$p[0]:
                if (this.bz != null) {
                    ...
                    this.m1 = this.m5(this.bz, this.od, "CloseColumn");
                }
                break;
            case "CloseColumn":
                if (this.mu != null && !this.mu.cn() && !this.m8) {
            ...
            case FinancialSeries.$$p[8]:
                if (this.bz != null) {
                    ...
                    this.m6 = this.m5(this.bz, this.ot, "VolumeColumn");
                }
                break;
            case "VolumeColumn":
                if (this.mu != null && !this.mu.cn() && !this.m8) {
    ...
    FinancialSeries.prototype.dw = function (a, b, c) {
        ...
        var e = c;
        if (this.bz == null || this.bz.count == 0 || !c.l() || b.isEmpty || a.isEmpty || this.l9 == null || this.mu == null || e.bu.b < 1 || this.l9.bh == null || this.mu.bh == null || this.mu.kb == this.mu.ka || this.l9.itemsSource == null || this.l9.j6 < 1) {
            e.bu.b = 0;
            d = false;
        }
        return d;
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 9:
                    if (!(f < d))
                        return [3 /*break*/, 12];
                    return [4 /*yield*/, (this.m2.item(e.item(f)) + this.m3.item(e.item(f)) + this.m1.item(e.item(f))) / 3];
                case 10:
                    _d.sent();
                    _d.label = 11;
                case 11:
                ...
                case 14:
                    if (!(h < g))
                        return [3 /*break*/, 17];
                    return [4 /*yield*/, (this.m2.item(h) + this.m3.item(h) + this.m1.item(h)) / 3];
                case 15:
                    _d.sent();
                    _d.label = 16;
                case 16:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(a > 0))
                        return [3 /*break*/, 2];
                    return [4 /*yield*/, this.n5(this.m2.item(b.item(0)) - this.m3.item(b.item(0)))];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                ...
                case 3:
                    if (!(c < a))
                        return [3 /*break*/, 6];
                    return [4 /*yield*/, Math.max(this.n5(this.m2.item(b.item(c)) - this.m3.item(b.item(c))), Math.max(this.n5(Math.abs(this.m2.item(b.item(c)) - this.m1.item(b.item(c - 1)))), this.n5(Math.abs(this.m3.item(b.item(c)) - this.m1.item(b.item(c - 1))))))];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5:
                ...
                case 7:
                    ...
                    if (!(d > 0))
                        return [3 /*break*/, 9];
                    return [4 /*yield*/, this.n5(this.m2.item(0) - this.m3.item(0))];
                case 8:
                    _a.sent();
                    _a.label = 9;
                case 9:
                ...
                case 10:
                    if (!(e < d))
                        return [3 /*break*/, 13];
                    return [4 /*yield*/, Math.max(this.n5(this.m2.item(e) - this.m3.item(e)), Math.max(this.n5(Math.abs(this.m2.item(e) - this.m1.item(e - 1))), this.n5(Math.abs(this.m3.item(e) - this.m1.item(e - 1)))))];
                case 11:
                    _a.sent();
                    _a.label = 12;
                case 12:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(a > 0))
                        return [3 /*break*/, 2];
                    return [4 /*yield*/, this.n5(this.m3.item(b.item(0)))];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                ...
                case 3:
                    if (!(c < a))
                        return [3 /*break*/, 6];
                    return [4 /*yield*/, Math.min(this.n5(this.m3.item(b.item(c))), this.n5(this.m1.item(b.item(c - 1))))];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5:
                ...
                case 7:
                    ...
                    if (!(d > 0))
                        return [3 /*break*/, 9];
                    return [4 /*yield*/, this.n5(this.m3.item(0))];
                case 8:
                    _a.sent();
                    _a.label = 9;
                case 9:
                ...
                case 10:
                    if (!(e < d))
                        return [3 /*break*/, 13];
                    return [4 /*yield*/, Math.min(this.n5(this.m3.item(e)), this.n5(this.m1.item(e - 1)))];
                case 11:
                    _a.sent();
                    _a.label = 12;
                case 12:
    ...
    FinancialSeries.prototype.getOpenColumnAsArray = function () {
        ...
        if (this.l9 != null && typeCast(ISortingAxis_$type, this.l9) !== null) {
            ...
            var a = new List$1(Number_$type, 2, this.m4.count);
            var b = this.l9.i$b;
            var c = this.m4.asArray();
    ...
    FinancialSeries.prototype.getHighColumnAsArray = function () {
        ...
        if (this.l9 != null && typeCast(ISortingAxis_$type, this.l9) !== null) {
            ...
            var a = new List$1(Number_$type, 2, this.m2.count);
            var b = this.l9.i$b;
            var c = this.m2.asArray();
            for (var d = 0; d < b.count; d++) {
                a.add(c[b._inner[d]]);
            }
            this.nv = a;
        ...
        switch (a) {
            case 1:
                for (var f = b; f < c; f++) {
                    var g = e._inner[f];
                    if (this.nx != null) {
                        this.nx.insert(f, this.m4.item(g));
                    }
                    if (this.nv != null) {
                        this.nv.insert(f, this.m2.item(g));
                    }
                    if (this.nw != null) {
                        this.nw.insert(f, this.m3.item(g));
                    }
                    if (this.nu != null) {
                        this.nu.insert(f, this.m1.item(g));
                    }
                    if (this.ny != null) {
            ...
            case 2:
                for (var h = b; h < c; h++) {
                    var i = e._inner[h];
                    if (this.nx != null) {
                        this.nx._inner[h] = this.m4.item(i);
                    }
                    if (this.nv != null) {
                        this.nv._inner[h] = this.m2.item(i);
                    }
                    if (this.nw != null) {
                        this.nw._inner[h] = this.m3.item(i);
                    }
                    if (this.nu != null) {
                        this.nu._inner[h] = this.m1.item(i);
                    }
                    if (this.ny != null) {
    ...
    FinancialSeries.prototype.ml = function (a, b) {
        var _this = this;
        var c = this.nt(this.m4);
        var d = this.nt(this.m1);
        var e = this.nt(this.m2);
        var f = this.nt(this.m3);
    ...
    FinancialSeries.prototype.o3 = function () {
        this.d8 = this.m1 == null || this.m1.count == 0 ? NaN : this.m1.item(this.m1.count - 1);
    };
