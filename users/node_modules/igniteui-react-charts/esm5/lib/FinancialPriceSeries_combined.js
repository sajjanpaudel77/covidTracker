...
var FinancialPriceSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FinancialPriceSeries.prototype.an = function (a) {
        if (a != null && a == this.mu && this.m3 != null && !isNaN_(this.m3.minimum) && this.m2 != null && !isNaN_(this.m2.maximum)) {
            return new AxisRange(this.m3.minimum, this.m2.maximum);
        }
        return null;
    };
    FinancialPriceSeries.prototype.ao = function () {
        if (this.m3 == null || this.m2 == null) {
            return null;
        }
        ...
        b = Math.max(0, Math.min(this.m3.count - 1, b));
        c = Math.max(0, Math.min(this.m3.count - 1, c));
        ...
        for (var g = truncate(b); g <= truncate(c); g++) {
            ...
            e = Math.min(e, this.m3.item(h));
            f = Math.max(f, this.m2.item(h));
        }
        return new AxisRange(e, f);
    };
    FinancialPriceSeries.prototype.eh = function () {
        return Series.ei(this.m4, typeCast(ISortingAxis_$type, this.l9));
    };
    FinancialPriceSeries.prototype.c9 = function (a) {
        ...
        if (b >= 0 && Rect.l_op_Inequality(c, null) && Rect.l_op_Inequality(d, null)) {
            ...
            if (this.mu != null && this.m3 != null && this.m2 != null && b < this.m3.count && b < this.m2.count) {
                var i = new ScalerParams(0, e, e, this.mu.ca, f);
                i.b = this.eh();
                var j = this.mu.dy(this.m3.item(b), i);
                var k = this.mu.dy(this.m2.item(b), i);
    ...
    FinancialPriceSeries.prototype.dw = function (a, b, c) {
        ...
        if (this.m4 == null || this.m1 == null || this.m2 == null || this.m3 == null) {
            d = false;
        }
        return d;
    };
    FinancialPriceSeries.prototype.o0 = function (a, b) {
        ...
        for (var r = b.bu.c; r <= b.bu.d; ++r) {
            ...
            if (k == null) {
                ...
                var u = k.i$d(t);
                var v = this.m4.item(t);
                var w = this.m2.item(t);
                var x = this.m3.item(t);
                var y = this.m1.item(t);
                var z = v;
                var aa = w;
                var ab = x;
                var ac = y;
                ...
                while (r < b.bu.d) {
                    ...
                    r++;
                    aa = Math.max(aa, this.m2.item(t));
                    ab = Math.min(ab, this.m3.item(t));
                    ac = this.m1.item(t);
                }
                var ae = NaN;
                if (!isNaN_(u)) {
