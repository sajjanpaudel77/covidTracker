...
var PieChartBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function PieChartBase() {
        ...
        _this.bf = null;
        _this.bg = null;
        _this.ar = new IndexCollection();
        _this.as = new IndexCollection();
        _this.ci = NaN;
        _this.ch = 1;
        ...
        _this.a4 = function (b, c) { return _this.fu(b, c.propertyName, c.oldValue, c.newValue); };
        ...
        _this.propertyUpdated = delegateCombine(_this.propertyUpdated, _this.a4);
        ...
        _this.bo = ((function () {
            ...
            $ret.create = runOn(_this.a0, _this.a0.g);
            $ret.activate = runOn(_this.a0, _this.a0.be);
            $ret.disactivate = runOn(_this.a0, _this.a0.bg);
            $ret.destroy = runOn(_this.a0, _this.a0.bf);
            return $ret;
        })());
        _this.bn = ((function () {
            var $ret = new Pool$1(PieLabel.$);
            $ret.create = runOn(_this.a0, _this.a0.d);
            $ret.activate = runOn(_this.a0, _this.a0.ar);
            $ret.disactivate = runOn(_this.a0, _this.a0.at);
            $ret.destroy = runOn(_this.a0, _this.a0.as);
            return $ret;
        })());
        _this.a3 = new PieChartSliceSelector(_this);
        FastItemObjectColumn.m();
        return _this;
    }
    PieChartBase.prototype.az = function () {
    ...
    PieChartBase.prototype.f2 = function (a) {
        ...
        var b = this.a0.b2.width;
        var c = this.a0.b2.height;
        var d = a.count;
    ...
    PieChartBase.prototype.fr = function () {
        ...
        for (var b = 0; b < this.bm.count; b++) {
            ...
            var e = this.ay == 1 ? c / this.c2 : c;
            var f = this.ay == 1 ? this.cw / 100 : this.cw;
            var g = true;
            if (e <= f && g) {
                this.cx = this.cx + c;
                this.b9.add(b);
    ...
    PieChartBase.prototype.fs = function () {
        ...
        var _loop_1 = function (c) {
            ...
            if (c == a - 1 && this_1.b9.count > 0) {
                f = this_1.eg;
                e = true;
                if (this_1.b0() || this_1.am != null || this_1.ap != null) {
                    var h = ((function () {
                ...
                if (this_1.b0() || this_1.am != null || this_1.ap != null) {
                    ...
                    if ((this_1.am != null && !e) || (this_1.ap != null && e)) {
                        if (e) {
                            formattedLabel_ = this_1.ap.i(k);
                        }
                        else {
                            formattedLabel_ = this_1.am.i(k);
                        }
                    }
                    else {
                        formattedLabel_ = this_1.a1(k);
                    }
    ...
    PieChartBase.prototype.fz = function () {
        ...
        var a = this.a0.b2.width;
        var b = this.a0.b2.height;
        if (b == 0 || a == 0) {
            return;
        }
    ...
    PieChartBase.prototype.f0 = function () {
        ...
        var _loop_2 = function (a) {
            ...
            var c = this_2.c6(a);
            var d = this_2.a0.bt(a);
            var e = this_2.a0.bu(a);
            b.content = ((function () {
                var $ret = new PieSliceDataContext();
                $ret.series = _this;
                $ret.slice = a;
            ...
            var f = b.content;
            if (this_2.b1() || this_2.an != null || this_2.ao != null) {
                var g = null;
                if (this_2.b1()) {
                    g = this_2.a2(b.content);
                }
                if (this_2.an != null && !f.isOthersSlice) {
                    g = this_2.an.i(b.content);
                }
                if (this_2.ao != null && f.isOthersSlice) {
                    g = this_2.ao.i(b.content);
                }
                if (g != null) {
    ...
    PieChartBase.prototype.bc = function () {
    ...
    PieChartBase.prototype.f9 = function (a, b, c) {
        ...
        var d = new SliceClickEventArgs(a, this.a0.ae(b));
        this.fp(this, d);
        if (!c) {
            this.a0.bn(a, b);
        }
    ...
    PieChartBase.prototype.b4 = function (a, b) {
        var c = new LabelClickEventArgs(a, this.a0.ae(b));
        this.fi(this, c);
