...
var RadialAreaSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialAreaSeries.prototype.no = function (a, b) {
        ...
        if (b.l() && !c.isEmpty && !d.isEmpty && this.m4 != null && this.m6 != null) {
            ...
            this.os = { $type: Point_$type, x: m, y: n };
            e.cy(a.f.count, h, false, this.ot.co.b, this.eu, runOn(this, this.oe), this.ou);
    ...
    RadialAreaSeries.prototype.get_n2 = function () {
        return true;
    };
    RadialAreaSeries.$t = markType(RadialAreaSeries, 'RadialAreaSeries', AnchoredRadialSeries.$);
    RadialAreaSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialAreaSeries, 'raisePropertyChanged', ['UnknownValuePlotting:ou:ow', [UnknownValuePlotting_$type, enumGetBox(UnknownValuePlotting_$type, 1)]]);
...
var RadialAreaSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialAreaSeriesView.prototype.cy = function (a, b, c, d, e, f, g) {
        this.cs.nu.i(this.cz, this.c1, this.c0, this.c2, a, b, c, d, e, f, g);
        this.an();
    };
