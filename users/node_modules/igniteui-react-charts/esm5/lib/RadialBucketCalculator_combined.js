...
var RadialBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function RadialBase() {
        ...
        _this.m7 = null;
        _this.nc = new SeriesRenderer$2(RadialFrame.$, RadialBaseView.$, 1, runOn(_this, _this.nn), runOn(_this, _this.no), runOn(_this, _this.ca), runOn(_this, _this.jm), runOn(_this, _this.nm), function (a) { return _this.m8.co.e(_this.eu); });
        return _this;
    }
    ...
    RadialBase.prototype.nm = function () {
        if (this.bt.g) {
            this.bt.t();
        }
    };
    ...
    RadialBase.prototype.i0 = function (a, b, c, d) {
        ...
        switch (b) {
            ...
            case "TransitionProgress":
                ...
                if (this.ez == 1) {
                    this.no(this.m9, this.m8);
                }
                else {
                    this.no(this.nb, this.m8);
                }
                if (this.bs != null) {
                    this.bs.jk(this);
                }
    ...
    RadialBase.prototype.eb = function (a) {
        var b = this.bi.bs;
        var c = this.bi.br;
        var d = -1;
        if (this.m4 != null && !b.isEmpty && !c.isEmpty && this.m7 != null) {
    ...
    RadialBase.prototype.ni = function () {
        var e_1, _a;
        var a = 0;
        try {
    ...
    RadialBase.$$p = markDep(DependencyProperty, PropertyMetadata, RadialBase, 'raisePropertyChanged', ['AngleAxis:m4:np', [CategoryAngleAxis.$, null], 'ClipSeriesToBounds:nf:nq', [0, false], 'ValueAxis:m6:nr', [NumericRadiusAxis.$, null]]);
    return RadialBase;
}(MarkerSeries));
export { RadialBase };
/**
