...
var RadialLineSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialLineSeries.prototype.no = function (a, b) {
        ...
        var l = b;
        l.cy(f, g, false, this.ou, this.ns(g, f - 1, b), l.co.b, this.eu);
    };
    ...
    RadialLineSeries.prototype.get_n2 = function () {
        return true;
    };
    RadialLineSeries.$t = markType(RadialLineSeries, 'RadialLineSeries', AnchoredRadialSeries.$);
    RadialLineSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialLineSeries, 'raisePropertyChanged', ['UnknownValuePlotting:ou:ow', [UnknownValuePlotting_$type, enumGetBox(UnknownValuePlotting_$type, 1)]]);
...
var RadialLineSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialLineSeriesView.prototype.cy = function (a, b, c, d, e, f, g) {
        this.cs.nu.m(this.c0, this.cz, this.c1, a, b, c, d, e, f, g);
        this.an();
    };
