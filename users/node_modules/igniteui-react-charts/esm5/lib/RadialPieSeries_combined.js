...
var RadialPieSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialPieSeries.prototype.no = function (a, b) {
        ...
        for (var s = 0; s < i.count; ++s) {
            ...
            var w = null;
            if (q) {
                w = this.o0(d, e, u - (m * 0.5), u + (m * 0.5), l, v, n, o, p);
            }
            else {
                w = this.o1(d, e, u - (m * 0.5), u + (m * 0.5), l, v, n);
            }
            t.ak = w;
            var x = i._inner[s][2];
            if (x > r) {
    ...
    RadialPieSeries.prototype.o1 = function (a, b, c, d, e, f, g) {
    ...
    RadialPieSeries.prototype.o0 = function (a, b, c, d, e, f, g, h, i) {
        var j = SliceCoords.a(a, b, c, d, e, f, g, h, i);
        if (j == null) {
            return this.o1(a, b, c, d, e, f, g);
        }
    ...
    RadialPieSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialPieSeries, 'raisePropertyChanged', ['RadiusX:ou:oy', [1, 2], 'RadiusY:ov:oz', [1, 2]]);
