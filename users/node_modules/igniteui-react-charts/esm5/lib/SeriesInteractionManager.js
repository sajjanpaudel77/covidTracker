...
var SeriesInteractionManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesInteractionManager.prototype.a$w = function (a, b, c, d, e) {
        var f = a.bi;
        f.aj();
        this.a$c = true;
        var g = a.fv(c, b);
        this.a$o = g;
        if (!e && a.bs != null && !a.aq.c) {
            this.q(a, b, g, d);
        }
        this.c = false;
        if (a.db && g == null) {
        ...
        if (a.bs != null && !this.c) {
            ...
            this.a$t(a, g, a.lp(b), true, false);
            a.bs.iu(a, g, d);
        }
    };
    ...
    SeriesInteractionManager.prototype.a$z = function (a, b, c, d, e) {
        ...
        if (a.bs != null && f != null && this.c) {
            this.c = false;
            this.d = true;
            this.a$t(a, f, a.lp(b), true, false);
            a.bs.iu(a, f, d);
        }
        if (a.bs != null && (!a.db || f != null) && !this.c) {
            this.a$t(a, f, a.lp(b), true, false);
            a.bs.iy(a, f, d);
        }
        if (f == null && !this.c && a.db) {
            this.a$t(a, f, a.lp(b), false, true);
