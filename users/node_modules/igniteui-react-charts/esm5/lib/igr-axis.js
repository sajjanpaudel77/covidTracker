...
var IgrAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    */
    ...
    IgrAxis.prototype.ensureLabelSettings = function () {
        ...
        this.i.ay.angle = this.i.dm();
        this.i.ay.leftMargin = this.i.dp();
        this.i.ay.rightMargin = this.i.dq();
        this.i.ay.topMargin = this.i.dr();
        this.i.ay.bottomMargin = this.i.dn();
        this.i.ay.horizontalAlignment = this.i.il();
        this.i.ay.verticalAlignment = this.i.jf();
    };
    ...
    IgrAxis.prototype.ensureTitleSettings = function () {
        ...
        this.i.be.angle = this.i.ds();
        this.i.be.leftMargin = this.i.du();
        this.i.be.rightMargin = this.i.dv();
        this.i.be.topMargin = this.i.dw();
        this.i.be.bottomMargin = this.i.dt();
        this.i.be.horizontalAlignment = this.i.im();
        this.i.be.verticalAlignment = this.i.jg();
    };
