...
import { StandardLegendBadges } from "igniteui-react-core";
...
export declare abstract class Axis extends Control implements INotifyPropertyChanged {
    ...
    private a8;
    readonly a9: IAxisVisualDataManager;
    dx(): number;
    fb(): any;
    fa(): any;
    ...
    constructor();
    private a6;
    readonly a7: IAxisAnnotationManager;
    readonly b3: boolean;
    private gi;
    private gj;
    private gg;
    ...
    private ak;
    readonly an: AxisAnnotationCollection;
    private al;
    private i1;
    i8: Rect;
    i7: Rect;
    ...
    ed(a: number): number;
    abstract readonly a1: AxisOrientation;
    jd: Size;
    gy(): void;
...
export declare abstract class AxisLabelPanelBase extends Panel {
    ...
    b9(a: AxisLabelPanelBaseView): void;
    ...
    protected bq(a: number, b: List$1<Rect>, c: List$1<boolean>): {
        ret: number;
        p1?: List$1<Rect>;
    };
    az(): List$1<Rect>;
    ...
    be(): number;
    bi(): number;
    ap(a: number, b: Rect): boolean;
    bd(a: any): number;
    bn(a: any): number;
    bf(a: any): number;
    bc(a: any): number;
    ao(): boolean;
    protected ci(a: Rect, b: Rect): void;
    protected b5(a: Rect, b: Rect): void;
    a0(): List$1<Rect>;
    bh(a: number, b: Size): number;
    ...
    bm(): number;
    cr(a: Size): Size;
    protected readonly al: boolean;
    cn(): Rect;
    protected bx(a: Size): void;
    protected bw(a: Size): void;
    protected b1(): void;
    protected ax(): IEnumerable$1<number>;
    readonly ag: AxisLabelsLocation;
    ch(a: GeometryCollection, b: number, c: number, d: number, e: Rect, f: PathRenderingInfo): void;
    b4(a: GeometryCollection, b: number, c: number, d: number, e: Rect, f: PathRenderingInfo): void;
    cc(a: FrameworkElement, b: number): void;
    cd(a: FrameworkElement): void;
    b3(a: FrameworkElement, b: number): void;
    cs(a: Size): Size;
    static readonly cj: DependencyProperty;
    ba: number;
    a6: number;
    ai(a: TitleSettings): AxisTitlePosition;
    ah(): AxisLabelsLocation;
    at(a: AxisLabelsLocation): boolean;
    private _av;
    av(): IEnumerable$1<any>;
    bt(a: number, b: TextBlock, c: number, d: number, e: number): string;
    bz(a: any): void;
    b8(a: FrameworkElement): void;
    private _aw;
...
export declare abstract class HorizontalAxisLabelPanelBase extends AxisLabelPanelBase {
    ...
    ad(): AxisLabelPanelBaseView;
    b9(a: AxisLabelPanelBaseView): void;
    ct: HorizontalAxisLabelPanelBaseView;
    c5: number;
    c2: number;
    c4: number;
    c3: number;
    ...
    ao(): boolean;
    az(): List$1<Rect>;
    c7(a: List$1<Rect>, b: List$1<boolean>, c: number): void;
    private c6;
    private c8;
    protected c9(a: List$1<Rect>, b: List$1<boolean>): void;
    protected da(): void;
    cc(a: FrameworkElement, b: number): void;
    protected cx(): boolean;
    protected cu(): boolean;
    protected bq(a: number, b: List$1<Rect>, c: List$1<boolean>): {
        ret: number;
        p1?: List$1<Rect>;
    };
...
export interface ISeriesInteractionManager {
    ...
    a$w(a: Series, b: Point, c: any, d: any, e: boolean): void;
...
export declare class XamDataChart extends SeriesViewer {
    ...
    nx: boolean;
    nu: boolean;
    pd(a: AxisLabelPanelBase, b: Rect, c: Rect, d: Rect): void;
    nc: BrushCollection;
    ne: BrushCollection;
    nd: BrushCollection;
    p1: Brush;
...
export declare abstract class Series extends Control implements INotifyPropertyChanged, IProvidesViewport, ILegendSeries, ILegendOwner, ILegendTemplateProvider {
    ...
    is(a: Point, b: any, c: any, d: boolean): void;
    jl(a: Point): void;
    private hr;
    private hv;
