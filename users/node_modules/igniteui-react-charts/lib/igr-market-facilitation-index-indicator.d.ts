...
* Example:
*/
export declare class IgrMarketFacilitationIndexIndicator extends IgrItemwiseStrategyBasedIndicator<IIgrMarketFacilitationIndexIndicatorProps> {
    protected createImplementation(): MarketFacilitationIndexIndicator;
    /**
                                 * @hidden
                                 */
    readonly i: MarketFacilitationIndexIndicator;
    constructor(props: IIgrMarketFacilitationIndexIndicatorProps);
}
